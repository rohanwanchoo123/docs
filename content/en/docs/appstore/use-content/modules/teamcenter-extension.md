...
As you work with the Teamcenter Extension and make adjustments to the generated artifacts, please be mindful of the following
* The **Create Item** action creates CreateInput entity while the **Revise Item Revision** creates the ReviseItemRevision entity. Do not adjust or delete these entities as they are internally used in the microflows generated by the respective actions
* Adjusting the generated microflows is highly inadvisable because editing the action will result in a removal of any custom change made to the generated microflow. To adjust it, use the edit button on the history tab to edit the integration.
